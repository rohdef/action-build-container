(function (factory) {
  ...
  protoOf(AtomicRef).cb = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).db = function () {
  ...
  protoOf(AtomicBoolean).eb = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).db = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).fb = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).db = function () {
    return this.kotlinx$atomicfu$value;
  };
